...
const NuevaNoticia = ({categorias, refrescar}) => {
    ...
    const guardar = () => {
      ...
      noticiaService.setNoticia(datos, e => {
    ...
    return(
        <div className="modal fade" id="modalguardar" tabIndex={-1} aria-labelledby="modalguardarLabel" aria-hidden="true">
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="modalguardarLabel">Añadir noticia</h5>
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-primary" data-dismiss="modal" onClick={guardar}>Guardar</button>
